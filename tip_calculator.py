...
if num_people >= 1:
        print(f"The cost should be {cost_of_meals / num_people}$ per person before tip and taxes.")
...
for tip in range(int(num_people)) :
       ...
       total_cost_each = (sum_per_person * float(tip))
       print(f"{round(total_cost_each, 2)}$ is how much you owe after tip.")
       total = tax + sum_per_person + total_cost_each
       round(total, 2)
       print(f"After everything the total for you is {total}$.")
